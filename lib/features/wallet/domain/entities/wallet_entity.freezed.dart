...
@override
String toString() {
  return 'WalletEntity(pharmacyId: $pharmacyId, pendingBalance: $pendingBalance, availableBalance: $availableBalance, totalWithdrawn: $totalWithdrawn, lifetimeEarnings: $lifetimeEarnings, totalOrders: $totalOrders, lastUpdated: $lastUpdated)';
}
...
class _WalletEntity extends WalletEntity {
  const _WalletEntity({required this.pharmacyId, required this.pendingBalance, required this.availableBalance, required this.totalWithdrawn, required this.lifetimeEarnings, required this.totalOrders, required this.lastUpdated}): super._();
